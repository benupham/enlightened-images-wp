...
archive.file(
  path.resolve(__dirname, "../../../../enlightened-images-pro/src/class-elim-pro-plugin.php"),
  {
    name: "../src/class-elim-pro-plugin.php"
  }
)
archive.file(
  path.resolve(__dirname, "../../../../enlightened-images-pro/enlightened-images-pro.php"),
  {
